...
- **Archive**:  
  Clicking the **Archive** button (marked with an arrow in the image) initiates the archiving process.  
...
Each project has a **Manage** tab. On this tab, you’ll find a button labeled **Define Prearchive Settings**.  
